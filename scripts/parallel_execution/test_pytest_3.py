...
class TestExampleThree:
    ...
    def test_login(self, setup):
        ...
        enter_text_in_element(driver, txt_box_username, data[2]['txt_box_username'])
        enter_text_in_element(driver, txt_box_password, data[2]['txt_box_password'])
        click_element(self.driver, btn_login)
        take_screenshot(driver, "problem_user.png")